...
<head>
  ...
  <!-- Toastr -->
  <link rel="stylesheet" type="text/css" href="{{ asset('admin_lte/plugins/toastr/toastr.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('admin_lte') }}/css/custom.css">
</head>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Terdapat {{ $notif->count() }} notifkasi</span>
          <div class="dropdown-divider"></div>
          @foreach ($notif->all() as $row)
            <a href="javascript::void(0)" class="dropdown-item">
              {{ $row->masterBarang->nama }} dibawah stok minimum
            </a>
          @endforeach 
        </div>
      </li>
...
<!-- Toastr -->
<script type="text/javascript" src="{{ asset('admin_lte/plugins/toastr/toastr.min.js') }}"></script>
<!-- Input Mask -->
<script type="text/javascript" src="{{ asset('admin_lte/plugins/inputmask/inputmask.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin_lte/plugins/inputmask/jquery.inputmask.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin_lte/plugins/inputmask/jquery.inputmask.bundle.js') }}"></script>
...
<script src="{{ asset('admin_lte') }}/js/pages/dashboard.js"></script>
